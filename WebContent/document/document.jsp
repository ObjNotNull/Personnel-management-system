			...
			<c:forEach items="${docs}" var="doc">
				<tr ondblclick="down(7);" class="main_trbg" align="center" id="data_0" style="background-color: rgb(255, 255, 255);">
					<td><input type="checkbox" id="box_0" value="7"></td>
					 <td>${doc.title}</td>
					 <td>
					  	<fmt:formatDate value="${doc.createDate}" pattern="yyyy年MM月dd日"/>
					  </td>
					  <td>${doc.userId}</td>
					  <td>${doc.remark}</td>
					 ...
					 <td align="center" width="40px;"><a href="showUpdateDocument.html">
					  ...
					  <form action="/project/document/down.action">
					  <input type="hidden" name="filename" value="${doc.filename}">
					  <input type="image" width="20" height="20" title="下载" src="../images/downLoad.png">
					  </form>
