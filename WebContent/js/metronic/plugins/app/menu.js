...
function loadMenu(){
	...
	+'"childs": [{"id": "111","name": "用户查询","icon": "","url": "/project/user/selectUserInf.action?cur=1&status=0","parentId": "11",'
	...
	+'"childs": [{"id": "121","name": "部门查询","icon": "","url": "/project/selectDepts.action?cur=1","parentId": "12",'
	...
	+'"childs": [{"id": "171","name": "文档查询","icon": "","url": "/project/document/selectDocuments.action?cur=1","parentId": "17",'
